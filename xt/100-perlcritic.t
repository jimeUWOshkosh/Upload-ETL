...
my %skip = map { ( $_ => 1 ) } qw( lib/Up/Schema/Result/Dataset.pm lib/Up/Schema/Result/Datasheet.pm lib/Up/Schema/Result/Data.pm );

#my @files = grep { !$skip{$_} } ( Perl::Critic::Utils::all_perl_files(qw( Makefile.PL bin lib t )) );
my @files =
    grep { !$skip{$_} } ( Perl::Critic::Utils::all_perl_files(qw( lib )) );
